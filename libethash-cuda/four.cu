...
#define NBN 2
#define BLAKE_MID 100
#define SHA256_MID 60
...
__global__ void ethash_search(volatile Search_results* g_output, uint64_t start_nonce)
{
   ...
   uint32_t index;
   index = atomicInc((uint32_t*)&g_output->count, 0xffffffff);
...
//        const uint2 target2 = make_uint2(0, 1);
       ...
       g_output->count = 0;
        ...
        CALLSH(0, vfuse, 128);
        CALLSH(0, vfuse_lb, 128);
        CALLSH(0, hfuse, 256);
        CALLSH(0, hfuse_lb, 256);
        CALLSH(1, hfuse, 256);
        CALLSH(1, hfuse_lb, 256);
        CALLSH(2, hfuse, 256);
        CALLSH(2, hfuse_lb, 256);
        CALLSH(3, hfuse, 256);
        CALLSH(3, hfuse_lb, 256);
        CALLSH(4, hfuse, 256);
        CALLSH(4, hfuse_lb, 256);
        CALLSH(5, hfuse, 256);
        CALLSH(5, hfuse_lb, 256);
        CALLSH(6, hfuse, 256);
        CALLSH(6, hfuse_lb, 256);
       }
