...
__global__ void sha256d_gpu_hash_shared_ethash_search3_100(const uint32_t threads0, const uint32_t startNonce1, uint32_t *resNonces2, volatile Search_results *g_output9, uint64_t start_nonce10)
{
...
//    ethash_search<<<gridSize, blockSize>>>(g_output, start_nonce);
    {
        ...
        cudaThreadSynchronize();
        sha256d_gpu_hash_shared_ethash_search3_1<<<grid_sha256, block_sha256.x+blockSize>>>(
            threads_sha256, 0, d_sha256_resNonces[0],
            g_output, start_nonce);
        cudaThreadSynchronize();
        sha256d_gpu_hash_shared_ethash_search3_100<<<grid_sha256, block_sha256.x+blockSize>>>(
            threads_sha256, 0, d_sha256_resNonces[0],
                g_output, start_nonce);
        cudaThreadSynchronize();
    }
